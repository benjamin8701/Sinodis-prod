({
	doInit : function(component, event, helper) {
        ...
        let getAccountAction = component.get("c.getShipTo");
        ...
        getAccountActionPromise.then(function(_returnValue){
            let sourceShipTo = _returnValue["sourceShipTo"];
            let fieldMap = _returnValue["fieldMap"];
            let crRTId = _returnValue["crRTId"];
            let fieldJSON = {};
            
			for(let element in fieldMap) {
                fieldJSON[element] = sourceShipTo[fieldMap[element]];
            };
            fieldJSON['recordTypeId'] = crRTId;
            fieldJSON['CN_Ship_To_Party__c'] = component.get("v.recordId");
